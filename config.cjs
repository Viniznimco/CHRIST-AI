...
const config = {
  ...
  /*christine zena tech added anti delete cmd*/
  ...
  BOT_NAME: process.env.BOT_NAME || "𝗖𝗛𝗥𝗜𝗦 𝗔𝗜",
  MENU_IMAGE: process.env.MENU_IMAGE || "https://files.catbox.moe/ntcw8m.jpg",
  DESCRIPTION: process.env.DESCRIPTION || "𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬 𝗖𝗛𝗥𝗜𝗦𝗧𝗜𝗡𝗘 𝗭𝗘𝗡𝗔",
  OWNER_NAME: process.env.OWNER_NAME || "𝗖𝗛𝗥𝗜𝗦𝗧𝗜𝗡𝗘 𝗭𝗘𝗡𝗔",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "254750737434",
